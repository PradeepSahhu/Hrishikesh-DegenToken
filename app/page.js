...
export default function Home({ params }) {
  ...
  const contractInstance = "0x682cF7419C16F6b4df0D4C0467a7D3029556B9da";
  ...
  return (
    <div className="bg-black font-myFont h-[100vh] m-0">
      <div className="w-full grid items-center my-10">
        <div className="grid grid-cols-4 gap-5">
          <div className="flex justify-center">
            <button
              className="bg-gradient-to-r from-blue-400 to-black px-8 pb-2.5 pt-3 text-xs font-medium uppercase leading-normal rounded-2xl"
      ...
      <div className="absolute inset-20 mt-20 rounded-xl bg-gray-800">
        <div className=" relative  h-9/12 rounded-xl mx-10 mt-10 flex justify-between">
          <div className="">
            <div className="my-2">
              <p className="text-xl ">
                Contract ID:
                <span className="text-blue-600 ml-2">{contractInstance}</span>
              </p>
            </div>
            <div className="my-2">
              <p className="text-xl">
            ...
            <div className="my-2">
              <p className="text-xl">
                Date Created:
                <span className="text-blue-600 ml-2">2024-10-04</span>
              </p>
            </div>
            <div className="my-2">
              <p className="text-xl">
                Genera: <span className="text-blue-600 ml-2">Degen Gaming</span>
              </p>
            </div>
        ...
        <div className="grid items-end my-5">
          <div className="flex justify-center gap-x-10">
            <div className="flex">
              <button
                className="px-10 rounded-xl bg-blue-600 pt-3 pb-2.5 shadow-orange-500 shadow-md"
